...
namespace Grape
{
    const static std::string TAG = "DeConv2d";
    ...
    void DeConv2d::ForwardCpu()
    {
        ...
        for(int i = 0; i < batch_size_; ++i){
            for(int j = 0; j < group_; ++j){
                ...
                float *b = in_data + (i*group_ + j)*m*k;
                float *c = im_col_data;

                gemm(1,0,n,k,m,1,a,n,b,k,0,c,k);

                if (ksize_ != 1) {
                    col2im_cpu(im_col_data, in_c_/group_, in_h_, in_w_, ksize_, stride_, padding_, out_data);
                }
            }
        }
    ...
    void DeConv2d::BackwardCpu()
    {
        ...
        for(int i = 0; i < batch_size_; ++i){
            for(int j = 0; j < group_; ++j){
                ...
                gemm(0,0,n,k,m,1,a,n,b,k,0,c,k);
    ...
    void DeConv2d::UpdateWeightsCpu(Optimizer &opt)
    {
    ...
    void DeConv2d::UpdateWeightsGpu(Optimizer &opt)
    {
    ...
    void DeConv2d::Load(cereal::BinaryInputArchive &archive)
    {

    }

    void DeConv2d::Load(cereal::JSONInputArchive &archive)
    {

    }

    void DeConv2d::Load(cereal::XMLInputArchive &archive)
    {

    }

    void DeConv2d::Save(cereal::BinaryOutputArchive &archive)
    {

    }

    void DeConv2d::Save(cereal::JSONOutputArchive &archive)
    {

    }

    void DeConv2d::Save(cereal::XMLOutputArchive &archive)
    {
